	...
	LPSTR lpCmdLine, int nCmdShow)
{
	...
	SelectObject(g_BackBufferDC, g_BackBufferBitmap); // MemDC의 메모리영역에 복사하기 
	...
	Gdiplus::Bitmap* g_pImageBitmap = new Gdiplus::Bitmap(L"../WorkBMP/WorkBMP/pc_0_1_spr_0.png");
	...
	while (true)
	{
		...
		// Render() DoubleBuffring 전면 버퍼에 출력한다. 
		g_pBackBufferGraphics->DrawImage(g_pImageBitmap, 0, 0);
		// 백버퍼에 저장하는 것이기 때무네 , 
		// 반복문으로 요소를 순회 시켜 애니메이션 출력 
